object FDKorps: TFDKorps
  Left = 192
  Top = 140
  Width = 637
  Height = 496
  Caption = 'Description du Corps du Graphe '
  Color = clBtnFace
  ...
  object avv: TAdvStringGrid
    ...
    RowHeaders.Strings = (
      ''
      'Echelle Jours Travaillés'
      'Echelle Jours Non Travaillés'
      'Echelle Week Ends Non Travaillés'
      'Distance Horizontale entre Taches'
      'Distance Verticale entre Taches')
    Lookup = False
    LookupCaseSensitive = False
    LookupHistory = False
    BackGround.Top = 0
