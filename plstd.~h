...
__published:	// IDE-managed Components
        ...
        TMenuItem *CocherToutesLesTaches2;
        TMenuItem *DcocherToutesLestaches2;
        ...
        TRadioButton *rbGantt;
        TRadioButton *rbCompr;
        TLabel *Label141;
        TLabel *Label142;
        TLabel *Label143;
        ...
        TButton *ButtonVis;
        TLabel *Label175;
        TAdvStringGrid *AdvStringGrid11;
        TImage *Image5;
        TImage *Image6;
        TAdvStringGrid *AdvStringGrid12;
        TButton *Button44;
        TTimer *Timer3;
        TTabSheet *TabSheet17;
        TAdvStringGrid *AdvStringGrid9;
        TButton *Button133;
        TTimer *Timer4;
        TButton *Button122;
        TTimer *Timer5;
        ...
        TAdvStringGrid *AdvStringGrid10;
        TTimer *Timer7;
        TTabSheet *TabSheet19;
        TAdvStringGrid *AdvStringGrid13;
        TButton *Button34;
        TButton *Button40;
        TSaveDialog *SaveDialog2;
        TAdvStringGrid *AdvStringGrid14;
        ...
        TButton *Button45;
        TButton *Button46;
        TAdvStringGrid *AdvStringGrid15;
        TLabel *Label177;
        TButton *Button47;
        TButton *Button48;
        TButton *Button413;
        ...
        TAdvStringGrid *AdvStringGrid16;
        TTimer *Timer10;
        TButton *Button51;
        TMemo *Memo1;
        TMemo *Memo2;
        ...
        void __fastcall SB1Scroll(TObject *Sender,
        ...
        void __fastcall btDPClick(TObject *Sender);
        ...
        void __fastcall trace_calChange(TObject *Sender);
        ...
        void __fastcall imGanttMouseMove(TObject *Sender,
          TShiftState Shift, int X, int Y);
        void __fastcall Label71DblClick(TObject *Sender);
        void __fastcall btAideGanttClick(TObject *Sender);
        void __fastcall btAideCritClick(TObject *Sender);
        void __fastcall Button10Click(TObject *Sender);
        void __fastcall btPL2HelpClick(TObject *Sender);
        void __fastcall btPL3HelpClick(TObject *Sender);
        void __fastcall Button14Click(TObject *Sender);
        void __fastcall CocherToutesLesTaches2Click(TObject *Sender);
        void __fastcall DcocherToutesLestaches2Click(TObject *Sender);
        void __fastcall CocherDcocher1Click(TObject *Sender);
        void __fastcall AffecterCritre1Click(TObject *Sender);
        void __fastcall Button5Click(TObject *Sender);
        void __fastcall RadioButton3ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall Button12Click(TObject *Sender);
        void __fastcall TabSheet9Show(TObject *Sender);
        void __fastcall avcGetFormat(TObject *Sender, int ACol,
          TSortStyle &AStyle, AnsiString &aPrefix, AnsiString &aSuffix);
        void __fastcall RadioButton2ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall Button15Click(TObject *Sender);
        void __fastcall TabSheet6Show(TObject *Sender);
        void __fastcall avGetFormat(TObject *Sender, int ACol,
          TSortStyle &AStyle, AnsiString &aPrefix, AnsiString &aSuffix);
        void __fastcall asTriGetFormat(TObject *Sender, int ACol,
          TSortStyle &AStyle, AnsiString &aPrefix, AnsiString &aSuffix);
        void __fastcall Button16Click(TObject *Sender);
        void __fastcall btDateClick(TObject *Sender);
        void __fastcall avactClickCell(TObject *Sender, int ARow,
          int ACol);
        void __fastcall avasCanEditCell(TObject *Sender, int ARow,
          int ACol, bool &CanEdit);
        void __fastcall avasCellValidate(TObject *Sender, int ACol,
          int ARow, AnsiString &Value, bool &Valid);
        void __fastcall btSaveActuClick(TObject *Sender);
        void __fastcall btEraseCritClick(TObject *Sender);
        void __fastcall btFilesizeClick(TObject *Sender);
        void __fastcall btCrit1Click(TObject *Sender);
        void __fastcall btCrit2Click(TObject *Sender);
        void __fastcall btCrit3Click(TObject *Sender);
        void __fastcall cbAvantChange(TObject *Sender);
        void __fastcall cbApresChange(TObject *Sender);
        void __fastcall ZoomChange(TObject *Sender);
        void __fastcall btPrintPDFAVClick(TObject *Sender);
        void __fastcall btActRapidClick(TObject *Sender);
        void __fastcall Button3Click(TObject *Sender);
        void __fastcall Button17Click(TObject *Sender);
        void __fastcall BitBtn1Click(TObject *Sender);
        void __fastcall BitBtn2Click(TObject *Sender);
        void __fastcall btBclClick(TObject *Sender);
        void __fastcall btPrepAvancClick(TObject *Sender);
        void __fastcall TabSheet3Show(TObject *Sender);
        void __fastcall Button18Click(TObject *Sender);
        void __fastcall cbLBClick(TObject *Sender);
        void __fastcall btPrepActClick(TObject *Sender);
        void __fastcall imP3pMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall btLBRISEEClick(TObject *Sender);
        void __fastcall Button21Click(TObject *Sender);
        void __fastcall Button22Click(TObject *Sender);
        void __fastcall Button23Click(TObject *Sender);
        void __fastcall Button24Click(TObject *Sender);
        void __fastcall Button25Click(TObject *Sender);
        void __fastcall cbAvantXChange(TObject *Sender);
        void __fastcall cbApresXChange(TObject *Sender);
        void __fastcall asAvancSelectCell(TObject *Sender, int ACol,
          int ARow, bool &CanSelect);
        void __fastcall btImportLiensClick(TObject *Sender);
        void __fastcall exec_Pl(TObject *Sender);
        void __fastcall edFINChange(TObject *Sender);
        void __fastcall Button26Click(TObject *Sender);
        void __fastcall TabSheet14Show(TObject *Sender);
        void __fastcall btChoixClick(TObject *Sender);
        void __fastcall Button27Click(TObject *Sender);
        void __fastcall btPreviewClick(TObject *Sender);
        ...
        void __fastcall rbGanttClick(TObject *Sender);
        void __fastcall rbComprClick(TObject *Sender);
        void __fastcall rbCoutClick(TObject *Sender);
        void __fastcall rbRessClick(TObject *Sender);
        void __fastcall btCrit4Click(TObject *Sender);
        void __fastcall btRAZClick(TObject *Sender);
        void __fastcall AdvStringGrid4ClickCell(TObject *Sender, int ARow,
          int ACol);
        ...
        void __fastcall AdvStringGrid6CanEditCell(TObject *Sender,
          int ARow, int ACol, bool &CanEdit);
        void __fastcall AdvStringGrid6ClickCell(TObject *Sender, int ARow,
          int ACol);
        void __fastcall AdvStringGrid6ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall AdvStringGrid6GetCellColor(TObject *Sender,
          int ARow, int ACol, TGridDrawState AState, TBrush *ABrush,
          TFont *AFont);
        void __fastcall AdvStringGrid6SelectCell(TObject *Sender, int ACol,
          int ARow, bool &CanSelect);
        void __fastcall AdvStringGrid7CanEditCell(TObject *Sender,
          int ARow, int ACol, bool &CanEdit);
        void __fastcall AdvStringGrid7CellValidate(TObject *Sender,
          int ACol, int ARow, AnsiString &Value, bool &Valid);
        void __fastcall AdvStringGrid7ClickCell(TObject *Sender, int ARow,
          int ACol);
        ...
        void __fastcall ButtonTacheClick(TObject *Sender);
        void __fastcall AdvStringGrid8KeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
        void __fastcall Button225Click(TObject *Sender);
        void __fastcall Timer3Timer(TObject *Sender);
        void __fastcall savefilecouts();
          void __fastcall savefilerest();
            void __fastcall savefileresj();
        ...
        void __fastcall Button431Click(TObject *Sender);
        ...
        void __fastcall Button413Click(TObject *Sender);
        void __fastcall TabSheet15ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        ...
        void __fastcall AdvStringGrid8CellValidate(TObject *Sender,
          int ACol, int ARow, AnsiString &Value, bool &Valid);
        ...
        void __fastcall AdvStringGrid8ClickCell(TObject *Sender, int ARow,
          int ACol);
...
private:	// User declarations
        ...
        int NUMT;  // tache avancement en cours de saisie
...
int    NB1,NB2,NB3,NB4;   // nb de jours entre deux dates
...
bool   flag_avanc;
int    DistAvanc;
char   TableDatesAV[50][30];
int    CntAV;
int    CntAVBefore;
char DATEAVANC_1[300];
char DatePrev[50];

#define MAX_CHAMP 100
char ch_cod[MAX_CHAMP][20];
char ch_des[MAX_CHAMP][150];
...
#define MAX_VOL 15
#define MAX_CHP 25
int vl_chp[MAX_VOL][MAX_CHP];   // 25 champs maximum par volets
bool flag_loadavanc;
bool flag_filter;
int  modfilter;
char strfilter[8000];
...
AnsiString MemoTypl2;
AnsiString MemoTypl3;
...
int    Tache_Fin;
char   Date_Fin_Reelle[20];

//char   nb_uses[250];
//int    nb_tries;

char Computed_Date[100];

char ACAL[10000];

char grosbuf[10000];

// Tableau pour minigraphique avancement
#define NBCells 20
int ddprev[NBCells];
int dprev[NBCells];
int dfprev[NBCells];
...
int  DDEB,DFIN,DFINMAX;
int  NBTACHES_AVANC;
int  DIST_AVANC;
int  Y_FIN_CAL,Y_BAS_PLANNING;
int  H_TITRE;
int  H_CAL;
int  DIST_AV_PREC;
int  DD1,DD2;
...
char FNAVANC[MAX_PATH];
char DATE_AVANC_1[20];
int DIST_AVANC_1;
char AN_1[10],MOIS_1[10],JOUR_1[10];
int  an_1,mois_1,jour_1;
int taches_concernees;

int AA_AV_1,MM_AV_1,JJ_AV_1;

int JOURS_RESTANTS;
float PERC_RESTANT;

int  FLAG_BRISEE[40][10000];       // Color,ORD
...
/////////////////////////////////////////////////////////////////////////////
        ...
        void __fastcall Effacer_Predecessurs(int tach);
        int  __fastcall Best_Pred(int indx,int tach); 
        bool __fastcall Open_Dump();
        void __fastcall Close_Dump();

        void __fastcall Exec_SAVE_CRIT(char *fname);


        void __fastcall  Load_Data_CSV(char *basename);
        void __fastcall  RemoveQuotes(char *pr);
        void __fastcall  Extract_Liens(char *fld,int nt,char *liens);

        void __fastcall Cout_Ressources();
        void __fastcall Compose_Cnn(char *dst,char *ch);
        void __fastcall Compute_Retards();
        void __fastcall Flag_Taches_Concernees();
        void __fastcall Print();
        void __fastcall Print_Bitmap(Graphics::TBitmap *imPP);
        void __fastcall Update_PCJT(int ixfin);
        bool __fastcall Update_IX();
        int __fastcall Compute_Taille(int type,int location); 
        AnsiString __fastcall Affich_Predecess(int i);
        float __fastcall ComputeFormat(TEdit *ed);
        // void __fastcall CopyCritTSL_AV();
        // void __fastcall Maj_CritAV1();
        int __fastcall  Compute_Date_0();
        int  __fastcall Compute_Date_100();   
        void __fastcall Remplir_asTri_Avanc();
        void __fastcall Copy_Calendar();
        int  __fastcall Fill_Avact(int concern);
        bool __fastcall IsConcern(int nt);
        void __fastcall Update_Aff_Concernees(int tcon);
        void __fastcall MAJ_ADV_AV();
        void __fastcall Modif_All_Links();
        bool __fastcall Modifiable(int row);
        void __fastcall Clean_Actu();
        void __fastcall Compute_Deb_Fin_Avanc();
        void __fastcall Faire_Brisee(int ORD,int numtache,int H2,int epaiss);
        void __fastcall Trace_Brisees();
        int __fastcall  Compute_Percent_RestantX(int row);
        int __fastcall  Compute_Jours_RestantsX(int row);
        bool __fastcall CorrectAvanc(char *parm);
        void __fastcall Rebuild_Sommets();
        int  __fastcall Find_Hole();
        void __fastcall Exec_Affect_Crit();
        void __fastcall Save_Crit_Renum();
        void __fastcall Write_Debut_DB(int mode);
        int  __fastcall Recherche_Responsable(int t);
        void __fastcall Build_Coches();
        void __fastcall Prepare_Tableau(int from,int Deb);
        void __fastcall Display_Graphics(int prt, TImage *imAC, TImage *imGNT);
        void __fastcall Display_Graphics2(int prt,TImage *imAC, TImage *imGNT);
        void __fastcall Refresh_Avanc(bool concern,bool strict);
        void __fastcall Refresh_Avanc_All();
        void _fastcall  ClickasAvanc();
        bool __fastcall Call_Process(int ch,int xcal,char *xtmp);
        void __fastcall BCL_PRED(int nt,char *result);
        void __fastcall BCL_SUCC(int nt,char *result);
        void __fastcall Exec_Excel_CSV();
        void __fastcall Exec_Import_CSV();
        void __fastcall Exec_Excel_CRIT();
        void __fastcall Exec_Excel_COUT();
        void __fastcall Save_Actualisation(bool msg);
        void __fastcall Exec_Avanc(bool skip);
        void __fastcall Deduct_JourRestant();
        void __fastcall Remplace_Crit(char *mc);
        void __fastcall TraceJNT(int nt, int dist1,int dist2,int x1,int y1,int x2, int y2,int freq);
        void __fastcall Fill_PredSucc_Av();
        void __fastcall Build_Criteres();
        AnsiString __fastcall text_criteres(int critnum ,AnsiString Crit);
        void __fastcall Synchro_LibCrit();
        void __fastcall xstrcat(char *dst, char * src);
        void __fastcall Regen_Criteres();
        int  __fastcall Posit(int n);
        void __fastcall EcoResize(int w,int h);
        void __fastcall ScanBuf(char *buf);
        void __fastcall Refresh_Couts();
        // void __fastcall CopyCriteres();
        int __fastcall ChercheRow(AnsiString numtache);
        int __fastcall CountWorkDay(int dist,int ncal);
        int  __fastcall Find_Index_Pred(int indx,int itask);
        void __fastcall Display_Aide(int rx, int ry);
        void __fastcall Libelle_Taches();
        int __fastcall Compute_LargeurMax(int i,bool real);
        // int __fastcall DecCounter();
        int __fastcall Compute_DebutSouhaite(int ACol,int AROw);
        int __fastcall Compute_FinSouhaitee(int ACol,int AROw);
        int __fastcall ComputeX1(int n,int bl,int w);
        AnsiString __fastcall Affich_Successeurs(int i);
        ...
        int __fastcall Compute_Month(int c_an,int c_mois,int c_jour,int mode);
        ...
        void __fastcall SelectPrinterAA(int modepdf,int dual,TImage *IM1, TImage *IM2);
        ...
        void __fastcall Commencer(int rupt,AnsiString txt,int notask,bool traits);
        ...
        AnsiString __fastcall text_rupt(int critnum,AnsiString Crit);
        ...
        int  __fastcall Exec_Alpha(char *ch,char *cond,char *v1,char *v2,int col);
        int  __fastcall Exec_Num(char *ch,char *cond,char *v1,char *v2);
        int  __fastcall Exec_Date(char *ch,char *cond,char *v1,char *v2);
        void __fastcall Draw_Rupture(int rupt,AnsiString txt,int notask);
        ...
        AnsiString bold, AnsiString text);
        */
        char __fastcall Call_Dialog(int x,int y, int mode);
        ...
        void __fastcall Border_Diagram(TImage *im);
...
/////////////////////////////////////////////////////////////////////////////
        ...
        int  __fastcall Deduire_Date(char *dt1, char *dtresult, int nb, bool jnt);
        void __fastcall Copy_Calendar(int zcal,int marge);
        ...
        int  __fastcall Verif_DecalX(int tpred, int tsucc, int typ, int decal);
        ...
        void __fastcall Image_Avanc(char *title,char *dtav,int col);
        ...
        void __fastcall Call_Preview();
        void __fastcall Call_Preview2();
        void __fastcall Refresh_Colors_Avact();

        int  __fastcall concat(char *tag);
        int  __fastcall Propage(int ch);
        int  __fastcall Faire_Riper();

        void __fastcall Copy_Binary(char *dest,char *src);
        void __fastcall Copy_Actu(char *oldname,char *newname,char *oldproj,char *newproj);
        char*  __fastcall str_replace_alpha(char *form,char *item,char *txt);

        int  __fastcall Compute_Fin_Reelle();
        ...
        int  __fastcall sub_jour(int year, int month, int day, int jours);
        ...
        int  __fastcall recule_jours(int base,int ncal, int dur);
        ...
        void __fastcall Compute_PlusTardA(char mode,bool disp);

        void __fastcall Compute_PlusTotAReel();
        void __fastcall Compute_PlusTardAReel(char mode,bool disp);

        int __fastcall Reverse_Date(char *dt);
        void __fastcall REVERSE_DATE(char *dt);

        void __fastcall DrawGantt(int task,int pos);
        void __fastcall DrawMiniGantt(int task,int pos,TImage *imgg,bool reel);
        ...
        void __fastcall Refresh_Concern(bool strict);
        void __fastcall Color_Avas();

        //void __fastcall WriteExchange(int n);
        //void __fastcall ReadExchange(int n);

        void __fastcall effacer_tache(int t,int posit);
        ...
        void __fastcall Compute_DD1_DD2();
         void __fastcall Compute_D1_D2();

        void __fastcall Compute_Nlle_Duree(int t);
        void __fastcall Compute_Nlle_DureeA(int t);

        int __fastcall  Row_AsAvanc(int indx);
        ...
        int  __fastcall Compute_Possible(int row,int ipred);
        ...
        //void __fastcall SaveCriteres(bool cpy);
        ...
        void __fastcall ZoomCopyAv(TImage *i,int X,int Y);

        int __fastcall Attrib_Tri();
        int __fastcall Lookup(int t);

        //  Tracé plannings et rapports
        ...
        void __fastcall Trace_Vertical(int ix,int freq);
        void __fastcall Trace_Taches();
        void __fastcall Trace_Liens_Prev();
        void __fastcall Trace_Liens_Reel();
        ...
        bool __fastcall Insert_Block(int ct,int i,int xwrite);
        ...
        void __fastcall ReloadAllData(char *name,bool xopen,bool datmodif);
        ...
        // void __fastcall Exec_Import_CSV();
        void __fastcall Exec_Export_Excel(bool question);
        void __fastcall conc(char *dst,char *src,int typel);

        void __fastcall Build_DateAvanc();
        void __fastcall FillListBoxA();

        void __fastcall Compute_Marqueur();  // pc implicite
        void __fastcall DefaultPage();
        void __fastcall Remplir_asCrit();

        void __fastcall SaveAs(bool reload);
        void __fastcall Save();

        void __fastcall Exec_RAZ();
...
public:		// User declarations
        ...
        //int __fastcall SaveAs(char *name);
         ...
         void __fastcall SaveCriteres(bool cpy);
         void __fastcall Remplir_AV1();
         void __fastcall cochertt(int Row);
         void __fastcall exportcentr(bool question);
         void __fastcall tachemereamont(int numero);
          int modelc;
      AnsiString name;
