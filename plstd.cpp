...
AnsiString datedebt;
 AnsiString datefint;
  AnsiString des2;
  vector<int> vectorsucc;
  vector<int>vectorpred;
  int ressglobal;
...
av->Cells[82][i].c_str(),                   //cout+P
av->Cells[85][i].c_str(),                   //cout  tot
av->Cells[86][i].c_str()                   //Cout/j
...
void __fastcall TplStandard::Load_Previsionnel()
{
 ...
 for (ix=1;ix<=LASTTASK;ix++)  //nb_taches;ix++)
 {
   ...
   //{
     ...
     AdvStringGrid1->Cells[17][cnt]= asCrit->Cells[3][ix];
     AdvStringGrid1->Cells[18][cnt]= asCrit->Cells[5][ix];
    AdvStringGrid1->Cells[19][cnt]= asCrit->Cells[7][ix];
    AdvStringGrid1->Cells[20][cnt]= asCrit->Cells[9][ix];
	AdvStringGrid1->Cells[22][cnt]= av->Cells[82][ix];
  
    AdvStringGrid1->Cells[23][cnt]= av->Cells[85][ix];
  AdvStringGrid1->Cells[24][cnt]= av->Cells[86][ix];
    AdvStringGrid1->Cells[14][cnt]= av->Cells[82][ix];
...
void __fastcall TplStandard::FormCreate(TObject *Sender)
{
  ...
  */
  ...
  AdvStringGrid1->ColWidths[23]=50;
  AdvStringGrid1->ColWidths[24]=70;
  AdvStringGrid1->ColWidths[25]=70;
  AdvStringGrid1->ColWidths[26]=90;
...
{
 AdvStringGrid1->Cells[17][i]= asCrit->Cells[3][i];
 AdvStringGrid1->Cells[18][i]= asCrit->Cells[5][i];
 AdvStringGrid1->Cells[19][i]= asCrit->Cells[7][i];
 AdvStringGrid1->Cells[20][i]= asCrit->Cells[9][i];
}
...
TabSheet4->TabVisible = false;
 ...
 AdvStringGrid2->Cells[4][0] = "Possible Début Prévisionnel";
  AdvStringGrid1->Cells[14][0] = "Coût+Pr";

     AdvStringGrid1->FontColors[14][0] = TColor(RGB(0,255,0));
   AdvStringGrid1->Cells[23][0] = "Coût+Pr";
        AdvStringGrid1->FontColors[23][0] = TColor(RGB(0,255,0));
   AdvStringGrid1->Cells[24][0] = "Res Total";
   AdvStringGrid1->Cells[25][0] = "Res/J";

        AdvStringGrid1->FontColors[24][0] = TColor(RGB(0,255,0));
AdvStringGrid1->Cells[26][0] = "Champs Libre";
   AdvStringGrid1->FontColors[25][0] = TColor(RGB(0,255,0));
AdvStringGrid1->Cells[29][0] = "Lien";
AdvStringGrid1->Cells[30][0] = "Décalage";
AdvStringGrid1->Cells[31][0] = "Successeur";


   AdvStringGrid1->MoveColumn(14,23);
      AdvStringGrid1->MoveColumn(23,24);
         AdvStringGrid1->MoveColumn(24,25);
            AdvStringGrid1->MoveColumn(25,26);
AdvStringGrid3->HideColumn(8);;
AdvStringGrid1->HideColumn(26);
AdvStringGrid1->HideColumn(27);
AdvStringGrid1->HideColumn(28);
AdvStringGrid1->HideColumn(29);
AdvStringGrid1->HideColumn(30);
AdvStringGrid1->HideColumn(31);
...
AnsiString ccd= ".project";
AnsiString cc= ProjectName;
AppendStr(cc,ccd);
if(FileExists(cc)){
AdvStringGrid16->LoadFromFile(cc);
}
    ...
    if (X2>=0)
       { imgg->Canvas->Pen->Width = 4;
        ...
        // else if (marg_tot[indice]==0) imgg->Canvas->Pen->Color = clRed;
         ...
         if(indice == task && trueorfalse == true)
         {
          imgg->Canvas->Font->Color = TColor(RGB(255,0,0));
         }
...
void __fastcall TplStandard::Copier_Cocher()
{
 ...
 char ps[5000];
     ...
     for (ix=1;ix<=cntrow;ix++)
     {
       ...
       if ((coche[i]=='X') && (su_tl[i][1] != 2))   // ne pas copier taches amont
       {
        ...
        strcpy(ftr[index],ftr[i]);
          AdvStringGrid1->Cells[14][index]  =  AdvStringGrid1->Cells[14][i];
          AdvStringGrid1->Cells[19][index]  =  AdvStringGrid1->Cells[19][i];
          AdvStringGrid1->Cells[20][index]  =  AdvStringGrid1->Cells[20][i];
          AdvStringGrid1->Cells[21][index]  =  AdvStringGrid1->Cells[21][i];
          AdvStringGrid1->Cells[22][index]  =  AdvStringGrid1->Cells[22][i];
           AdvStringGrid1->Cells[24][index]  =  AdvStringGrid1->Cells[24][i];
          AdvStringGrid1->Cells[23][index]  =  AdvStringGrid1->Cells[23][i];
          AdvStringGrid1->Cells[17][index]  =  AdvStringGrid1->Cells[17][i];
        AdvStringGrid1->Cells[18][index]  =  AdvStringGrid1->Cells[18][i];
          AdvStringGrid1->Cells[19][index]  =  AdvStringGrid1->Cells[19][i];
         AdvStringGrid1->Cells[20][index]  =  AdvStringGrid1->Cells[20][i];
           AdvStringGrid1->Cells[25][index]  =  AdvStringGrid1->Cells[25][i];
         AdvStringGrid1->Cells[26][index]  =  AdvStringGrid1->Cells[26][i];
           AdvStringGrid1->Cells[27][index]  =  AdvStringGrid1->Cells[27][i];
        ...
        av->Cells[82][index] = av->Cells[82][i];
      ...
      if (coche[i]=='X')
       {
        ...
        //Corrections pour Couts et Res/Total
                for (int jx=1;jx<=cntrow;jx++)
     {
       strcpy(tmp,AdvStringGrid1->Cells[1][jx].c_str());
  ...
  Change1();
  Save();
  AdvStringGrid1->SaveToFile("donnees");
  AdvStringGrid10->LoadFromFile("donnees");
}
      ...
      int ARow, int ACol, bool &CanEdit)
{
 ...
 if (ACol== 2|| ACol == 3 ||ACol == 25 || ACol == 26 ||ACol == 27 || ACol!=21||ACol != 18|| ACol != 19|| ACol != 20|| ACol>9)  //  Champs Libres  et montant
    CanEdit=true;
 StatusBar1->SimpleText="";
 CanEdit=true;
 }
      ...
      int ARow, int ACol)
{
 ...
 if(ACol == 0)
 {
   tachesel = StrToInt(AdvStringGrid1->Cells[1][ARow]);
   cochertt(ARow); }
}
//---------------------------------------------------------------------------
      ...
      int ACol, int ARow, AnsiString &Value, bool &Valid)
{
  ...
  AdvStringGrid9->Cells[2][vel] =Value;
     Valid=true;
     break;
 ...
 case 10 :  // calendrier
  ...
  AdvStringGrid9->Cells[10][vel] =Value;
     Valid = true;
     break;
  ...
  AdvStringGrid9->Cells[11][vel] =Value;
     break;

  case 12:  // Debut Souhaité
     vel = StrToInt(AdvStringGrid1->Cells[1][ARow]);

     if (Compute_DebutSouhaite(ACol,ARow)){
       AdvStringGrid9->Cells[12][vel] =Value;
      Valid = true;}
     else Valid=false;
  ...
  case 13 : // Fin Souhaitée
     ...
     if (Compute_FinSouhaitee(ACol,ARow)){
      AdvStringGrid9->Cells[13][vel] =Value;
  ...
  case 22:
     ...
     vel = StrToInt(AdvStringGrid1->Cells[1][ARow]);
  av->Cells[82][ctask]=Value;
      AdvStringGrid9->Cells[22][vel] =Value;
   Valid=true; break;
  case 29:

     vel = StrToInt(AdvStringGrid1->Cells[1][ARow]);
  av->Cells[91][ctask]=Value;
      AdvStringGrid9->Cells[29][vel] =Value;
  Valid=true; break;   // champ libre 1
  case 23:
       vel = StrToInt(AdvStringGrid1->Cells[1][ARow]);
  if(AdvStringGrid1->Cells[23][ctask] ==""){AdvStringGrid1->Cells[24][ctask] ="";AdvStringGrid1->Refresh();
      AdvStringGrid9->Cells[23][vel] ="";  AdvStringGrid9->Cells[23][vel] ="";
       Valid=true;}else{
  tott = StrToInt(AdvStringGrid1->Cells[23][ctask]);
  durt = StrToInt(AdvStringGrid1->Cells[3][ctask]);
   ...
   rest = (tott/durt);
  AdvStringGrid1->Cells[24][ctask]  = FloatToStr(rest);
  av->Cells[85][ctask]=Value;
  av->Cells[86][ctask]=AdvStringGrid1->Cells[24][ctask];

      AdvStringGrid9->Cells[23][vel] =Value;
      AdvStringGrid9->Cells[24][vel] =AdvStringGrid1->Cells[24][ctask];
  Valid=true; }
  ...
  case 24:
     ...
     vel = StrToInt(AdvStringGrid1->Cells[1][ARow]);
   if(AdvStringGrid1->Cells[24][ctask] ==""){AdvStringGrid1->Cells[23][ctask] ="";AdvStringGrid1->Refresh();
   AdvStringGrid9->Cells[23][vel] ="";  AdvStringGrid9->Cells[23][vel] ="";
   Valid=true; }else{
  ...
  av->Cells[86][ctask]=Value;
  av->Cells[85][ctask]=AdvStringGrid1->Cells[23][ctask];Valid=true;
  AdvStringGrid9->Cells[24][vel] =Value;
      AdvStringGrid9->Cells[23][vel] =AdvStringGrid1->Cells[23][ctask];
 ...
 int a,nt;
  ...
  ctask=Lect_Numt(ARow);
   ...
   if (dt2[0]==' ') { AdvStringGrid1->Cells[ACol][ARow]=""; return 0; }
    ...
    savefilerest();
    savefileresj();
    AdvStringGrid9->SortIndexes->Clear();
...
int __fastcall  TplStandard::grefresh(int task,char mode)
{
 ...
 Label11->Caption = AnsiString(first);
  ...
  DrawMiniGantt(current_task,0,Image2,false);
...
void __fastcall TplStandard::AdvStringGrid3SelectCell(TObject *Sender,
      int ACol, int ARow, bool &CanSelect)
{
if(abstate == 1 && AdvStringGrid8->Cells[1][1] != "")
 {
  AdvStringGrid3->Cells[6][ACol] = ARow;
  return;
 }
 SG3Col=ACol;
   ...
   for (i=1;i<=LASTTASK;i++)
   {
    ...
    if(av->Cells[1][ntach] !="")
    {
...

     {
      ...
      asCrit->Cells[14][cnt] = av->Cells[82][ntach];
      ...
      AdvStringGrid1->Cells[15][cnt] = av->Cells[41][ntach];
      AdvStringGrid1->Cells[16][cnt] = av->Cells[42][ntach];
      AdvStringGrid1->Cells[17][cnt] = av->Cells[43][ntach];
      AdvStringGrid1->Cells[15][cnt] = av->Cells[44][ntach];

      AdvStringGrid1->Cells[22][cnt] = av->Cells[82][ntach];
      AdvStringGrid1->Cells[23][cnt] = av->Cells[85][ntach];
      AdvStringGrid1->Cells[24][cnt] = av->Cells[86][ntach];
...
/*AdvStringGrid1->Cells[17][ndx]= asCrit->Cells[3][i];
AdvStringGrid1->Cells[18][ndx]= asCrit->Cells[5][i];
AdvStringGrid1->Cells[19][ndx]= asCrit->Cells[7][i];
AdvStringGrid1->Cells[20][ndx]= asCrit->Cells[9][i];

  AdvStringGrid1->Cells[22][ndx]= av->Cells[82][i];
  AdvStringGrid1->Cells[23][ndx]= av->Cells[85][i];
  AdvStringGrid1->Cells[24][ndx]= av->Cells[86][i]; */
  ...
  for(int i = 1; i< AdvStringGrid1->RowCount; i++)
  {
   nrt = StrToInt(AdvStringGrid1->Cells[1][i]);
    AdvStringGrid1->Cells[17][i] = AdvStringGrid9->Cells[17][nrt];
   AdvStringGrid1->Cells[18][i] = AdvStringGrid9->Cells[18][nrt];
   AdvStringGrid1->Cells[19][i] = AdvStringGrid9->Cells[19][nrt];
   AdvStringGrid1->Cells[20][i] = AdvStringGrid9->Cells[20][nrt];
   AdvStringGrid1->Cells[21][i] = AdvStringGrid9->Cells[21][nrt];
   AdvStringGrid1->Cells[22][i] = AdvStringGrid9->Cells[22][nrt];
   AdvStringGrid1->Cells[23][i] = AdvStringGrid9->Cells[23][nrt];
   AdvStringGrid1->Cells[24][i] = AdvStringGrid9->Cells[24][nrt];
   AdvStringGrid1->Cells[25][i] = AdvStringGrid9->Cells[25][nrt];
  }
       ...
       AdvStringGrid1->Cells[20][ndx] = avc->Cells[8][i];
...
// Init_Grids();
 ...
 for(int i = 1; i < AdvStringGrid1->RowCount; i++)
 {
  nr = StrToInt(AdvStringGrid1->Cells[1][i]);
  AdvStringGrid1->Cells[17][i] =  AdvStringGrid9->Cells[17][nr];
  AdvStringGrid1->Cells[18][i] =  AdvStringGrid9->Cells[18][nr];
 AdvStringGrid1->Cells[19][i] =   AdvStringGrid9->Cells[19][nr];
AdvStringGrid1->Cells[20][i] =    AdvStringGrid9->Cells[20][nr];

  AdvStringGrid1->Cells[22][i] =  AdvStringGrid9->Cells[22][nr];
  AdvStringGrid1->Cells[23][i] =  AdvStringGrid9->Cells[23][nr];
  AdvStringGrid1->Cells[24][i] =  AdvStringGrid9->Cells[24][nr];
     ...
     switch (pc)
      {
       ...
       case 2: Prepare_Draw_Planning(); ZoomCopy2(imP2p,0,0); break;
       case 3: Prepare_Draw_Planning(); ZoomCopy3(imP3p,0,0); break;
       //case 3: Prepare_Draw_Planning(); ZoomCopycopyAv(imPort,0,0); break;
       case 4: Prepare_Draw_Rapport(1); ZoomCopy4(imR1p,0,0); break;
       // case 5: Prepare_Draw_Rapport(1); ZoomCopy5(imR2p,0,0); break;
      }
...
*/
 ...
 if (lg>0) {
             ...
             else if  (strcmp(m_excel,"excentr")==0) Button34->Click();
             else if  (strcmp(m_excel,"impcentr")==0) Button40->Click();
             m_excel[0]=0;
           }
 lg = strlen(m_save);
 if (lg>0)
        ...
        for (x=1;x<ct;x++)
          {
           ...
           if (strcmp(val,oc)==0)
             { asCrit->Cells[col][x]=AnsiString(nc)+ "@";
               ...
               if (nt != 0)
                 {
                  if (col==3){AdvStringGrid9->Cells[17][nt]=AdvStringGrid1->Cells[17][nt]; AdvStringGrid1->Cells[17][nt]=AnsiString(nc);av->Cells[41][nt]=AnsiString(nc);}
                  if (col==5){AdvStringGrid9->Cells[18][nt]=AdvStringGrid1->Cells[18][nt];  AdvStringGrid1->Cells[18][nt]=AnsiString(nc);av->Cells[42][nt]=AnsiString(nc); }
                  if (col==7){AdvStringGrid9->Cells[19][nt]=AdvStringGrid1->Cells[19][nt]; AdvStringGrid1->Cells[19][nt]=AnsiString(nc);av->Cells[43][nt]=AnsiString(nc); }
                  if (col==9){
                   ll = AnsiString(nc);
                   AdvStringGrid9->Cells[20][nt]=ll;
                   AdvStringGrid1->Cells[20][nt]=ll;
                   av->Cells[44][nt]=ll;
                  }
                 }
...
i = 1;
  ...
  while (i<=AdvStringGrid1->RowCount)
  {
    strcpy(tmp,AdvStringGrid1->Cells[1][i].c_str());
    j = atoi(tmp);
    if (av->Cells[1][i] != "" && av->Cells[1][i] == IntToStr(j))
          {
            strcpy(tmp,"");
            ...
            strcat(tmp,"\""); strcat(tmp,av->Cells[12][i].c_str()); strcat(tmp,"\";");  // Début  Souhaité
            strcat(tmp,"\""); strcat(tmp,av->Cells[13][i].c_str()); strcat(tmp,"\";");  // Fin Souhaitée

            strcpy(small,av->Cells[1][i].c_str());
            nt = atoi(small);
            if (nt != 0)
              {
               // bcl Pred
            ...
            // Code tache
            strcat(tmp,"\""); strcat(tmp,av->Cells[11][i].c_str()); strcat(tmp,"\";");
            // Cout +
    ...
    if (nt>0)
      {
        ...
        if (mt>=0.0)
          { sprintf(tmp,"%.2f",mt);
            AdvStringGrid1->Cells[17][nb_taches]=AnsiString(tmp);
    ...
    if (av->Cells[1][i] != "" && av->Cells[1][i] != " ")
      {
       ...
       //Charger criteres dans AdvStringGrid


AdvStringGrid1->Cells[17][indx] = avc->Cells[9][indx];
AdvStringGrid1->Cells[18][indx] = avc->Cells[10][indx];
AdvStringGrid1->Cells[19][indx] = avc->Cells[11][indx];
AdvStringGrid1->Cells[20][indx] = avc->Cells[8][indx];
...
for (i=1;i<cntt;i++)
  ...
  if(modeal==1){
   strcpy(mt,AdvStringGrid1->Cells[22][i].c_str());}
   if(modeal==2){
...
// Application->MessageBoxA(m_exchange,m_ecoplan,MB_OK);
 ...
 Ghost->ExtractValue(tmp,m_exchange,"decoch",0);
 if (strcmp(tmp,"O")==0) Tout_Decocher();
 if(salope== "*PHASES" || salope== "*INTERVENANTS"||salope== "*TRIS" ||salope == "*RESSOURCES")
 {
...
ctask = current_task;
new_nb_taches=nb_taches;
ShowMessage(IntToStr(new_nb_taches));
ShowMessage(IntToStr(nb_taches));
for (ix=1;ix<=LASTTASK;ix++)
   {
     if (coche[ix]=='X')
         {
      ...
      int ARow, int ACol)
{
 ...
 if(abstate==1)          MemoDecal3=AdvStringGrid3->Cells[ACol][ARow];
  ...
  if (CntAVBefore == 0)
   { strcpy(FNAVANC,""); D1=0; DIST_AVANC_1=0;
     ...
     Avant = cbAvant->Text;
          ...
          if (Avant == "1 Semaine Avant") D1 = 7; //D1=dist - 7;
           else if ( Avant == "2 Semaines Avant")D1 =14; //D1=dist - 14;
           else if ( Avant == "1 Mois Avant") D1=19; //D1=dist - 30;
           else if (Avant == "Début Actualisation") D1 = 0; // D1=0; //dist;
...
/*  else if (CntAVBefore == 1)
   ...
   strcpy(tmp,TableDatesAV[0]);
      ...
      strcat(FNAVANC,tmp);
          ...
          if (Avant == "1 Semaine Avant") D1 = 0; //D1=dist - 7;
           else if ( Avant == "2 Semaines Avant")D1 =0; //D1=dist - 14;
           else if ( Avant == "1 Mois Avant") D1=0; //D1=dist - 30;
           else if (Avant == "Début Actualisation") D1 = 0; // D1=0; //dist;
           else D1=0;  // prévisionnel
         //
        ...
        if (strcmp(tmp,DATEAVANC)==0)
          {
           ...
           else if (Avant == "Début Actualisation") D1=0;//D1=dist;
           else D1=0;  // prévisionnel
          }
       else
          {
...
// preview->Left=10;}else{
 ...
 preview->Image1->Height=preview->Height- preview->Image1->Height;
...
char tmp[250];
 ...
 pc=0;
 strcpy(P_NOM[0],"1.5 ebauche gantt");
...
P_FILTRE[pc] ="";
P_TRI[pc] = "1.5 tâches classées par marge";
P_GENRE[pc]='G';
     Label7->Caption = "";
...
char tmp[250];
 ...
 pc=0;
 strcpy(P_NOM[0],"1.5 ebauche avec marge");
...
cpter=+1;
AdvStringGrid1->SaveToFile("abcdef");
break;
...
AdvStringGrid1->ColWidths[10]=25;
cpter2--;
break;
}
}
...
//---------------------------------------------------------------------------
void __fastcall TplStandard::cochertt(int Row)
{

if(find(vtaches.begin(),vtaches.end(),Row) != vtaches.end() && !vtaches.empty())
{
vtaches.erase(remove(vtaches.begin(), vtaches.end(),Row),vtaches.end());
 asCrit->Cells[0][Row]="";
 }else{
 vtaches.push_back(Row);
 asCrit->Cells[0][Row]= tachesel;
 }
}
//---------------------------------------------------------------------------
...
void __fastcall TplStandard:: Call_Preview2()
{
  TPreview *preview;
 preview = new TPreview(Application);
...
void __fastcall TplStandard::BitBtn11Click(TObject *Sender)
{

if(tachesel = 0)
{
 ShowMessage("Veuillez selectionner une tache!");
 return;

}
 TabSheet15->TabVisible = true;
 PageControl1->ActivePageIndex =15;
 AnsiString tachem = "Tache numéro ";

 AdvStringGrid8->Cells[0][1] = tachem+IntToStr(ARowT);
  AdvStringGrid8->Cells[1][1] = AdvStringGrid1->Cells[3][ARowT];
    AdvStringGrid8->Cells[2][1] ="0";
      AdvStringGrid8->Cells[3][1] = AdvStringGrid1->Cells[21][ARowT];
      AdvStringGrid8->Cells[4][1] = AdvStringGrid1->Cells[11][ARowT];
        AdvStringGrid8->Cells[5][1] = "0";
}
//---------------------------------------------------------------------------


void __fastcall TplStandard::ButtonTacheClick(TObject *Sender)
{
Display_Graphics(4,Image6, Image5);
}
//---------------------------------------------------------------------------
...
void __fastcall TplStandard::AdvStringGrid8KeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
   var1 = 2;
   var2 = 1;
   AnsiString counttache="11";
   int ctaches;
   int numtc;
int nt;
int nrtt= StrToInt(Label181->Caption);
int nrtt2= StrToInt(Label185->Caption);
int selnr;
if (Key == VK_INSERT)
  {    //  insertion d une tache a la fin

if(counter<10){
AdvStringGrid8->RowCount++;
AdvStringGrid1KeyDown(Sender, VK_INSERT,
      Shift);
  nrtt=nrtt-1;
...
for(int i= var2; i < AdvStringGrid8->RowCount; i++){

if(var1!= 12){
AdvStringGrid8->Cells[0][var1] = des + "*";
AdvStringGrid8->Cells[1][var1] = "1";
AdvStringGrid8->Cells[2][var1] = "DD";
AdvStringGrid8->Cells[3][var1] = "0";
AdvStringGrid8->Cells[4][var1] = "R---";
AdvStringGrid8->Cells[5][var1] = "0";
AdvStringGrid8->Cells[6][var1] = AdvStringGrid8->Cells[6][1];
AdvStringGrid8->Cells[7][var1] = des2;
var1++;
var2++;

int ta = StrToInt(counttache);
ta--;
counttache = IntToStr(ta);
selnr=nrtt-var2-1;
AdvStringGrid1CellValidate(Sender,2, selnr,AdvStringGrid8->Cells[0][var1],true);
AdvStringGrid1CellValidate(Sender,3, selnr,AdvStringGrid8->Cells[1][var1],true);
AdvStringGrid1CellValidate(Sender,20, selnr,AdvStringGrid8->Cells[4][var1],true);

}else
{
ShowMessage("Limite pour creation des taches filles atteinte");
goto end;
}

}

kj =StrToInt(Label178->Caption);
kj++;
Label178->Caption = IntToStr(kj);
end:
 }  // VK_INSERT

}
//---------------------------------------------------------------------------
void __fastcall TplStandard::Button225Click(TObject *Sender)
{
   AnsiString dayss, dayss2;
   TDate one, two, three;

 for(int i = 1; i <avact->RowCount; i++)
 {
   dayss = AdvStringGrid1->Cells[4][StrToInt(avact->Cells[1][i])];
   dayss2 = AdvStringGrid1->Cells[5][StrToInt(avact->Cells[1][i])];
   one = StrToDate(dayss);
   two = StrToDate(dayss2);
   AnsiString dayss3 = StringReplace(Label118->Caption,"-", "/",
   TReplaceFlags() << rfReplaceAll);
   ShortDateFormat = "dd/mm/yy";

   three = StrToDate(dayss3);

   if(one> three || two< three)
   {
     avactClickCell(Sender, i, 3);
...
void __fastcall TplStandard::Timer3Timer(TObject *Sender)
{
  btActRapid->Click();
  Timer3->Enabled = false;
}
//---------------------------------------------------------------------------
void __fastcall TplStandard::savefilecouts()
{
/*
for(int i=1;i<AdvStringGrid1->RowCount; i++)
{
AdvStringGrid16->Cells[0][i]=AdvStringGrid1->Cells[23][i];
AdvStringGrid16->Cells[1][i]=AdvStringGrid1->Cells[24][i];
AdvStringGrid16->Cells[2][i]=AdvStringGrid1->Cells[25][i];
}


AdvStringGrid16->SaveToFile(ProjectName);*/
/*
  AnsiString couts;
   AnsiString path = AnsiString(ProjectDirectory)+"\\"+ProjectName+"couts";

    AnsiString donnee;
   ofstream monFichier;
    if(monFichier.is_open(path.c_str())){
   for(int i = 1; i <AdvStringGrid1->RowCount; i++)
   {
  donnee = AdvStringGrid1->CellSize[14][i];
          monFichier <<donnee;
   }
   monFichier.close();}else{
             monFichier.open(path.c_str(), fstream::trunc | fstream::out);
             monFichier <<"\n";
             monFichier.close();
             }              */
...
void __fastcall TplStandard::savefilerest()
{                         /*
   AnsiString restotal;
   AnsiString path = AnsiString(ProjectDirectory)+"\\"+ProjectName+"rest";
    ...
    if(monFichier.is_open(path.c_str()))
{
   for(int i = 1; i <AdvStringGrid1->RowCount; i++)
   {
  donnee= AdvStringGrid1->CellSize[23][i];
         monFichier << donnee;
   }
   monFichier.close();
              }else{
             monFichier.open(path.c_str(), fstream::trunc);
             monFichier <<"\n";
             monFichier.close();
             }          */
}
...
void __fastcall TplStandard::savefileresj()
{
AnsiString str1 =ProjectName;
AppendStr(str1,".rf");
AdvStringGrid1->SaveToFile(str1);

   /*
   AnsiString resj;
   AnsiString path = AnsiString(ProjectDirectory)+"\\"+ProjectName+"resj";
  AnsiString donne;
...
void __fastcall TplStandard::openfile()
{

AnsiString str1 =ProjectName;
AppendStr(str1,".rf");
AdvStringGrid16->LoadFromFile(str1);

for(int i=1; i< AdvStringGrid16->RowCount;i++)
{
  AdvStringGrid16->Cells[17][i]=  AdvStringGrid1->Cells[17][i];
    AdvStringGrid16->Cells[18][i]=  AdvStringGrid1->Cells[18][i];
    AdvStringGrid16->Cells[19][i]=  AdvStringGrid1->Cells[19][i];
    AdvStringGrid16->Cells[20][i]=  AdvStringGrid1->Cells[20][i];
    AdvStringGrid16->Cells[21][i]=  AdvStringGrid1->Cells[21][i];
    AdvStringGrid16->Cells[22][i]=  AdvStringGrid1->Cells[22][i];
    AdvStringGrid16->Cells[23][i]=  AdvStringGrid1->Cells[23][i];

}
/*
AdvStringGrid16->LoadFromFile(ProjectName);
for(int i=1;i<AdvStringGrid16->RowCount; i++)
{
AdvStringGrid1->Cells[23][i]=AdvStringGrid16->Cells[0][i];
AdvStringGrid1->Cells[24][i]=AdvStringGrid16->Cells[1][i];
AdvStringGrid1->Cells[25][i]=AdvStringGrid16->Cells[2][i];
}                        */


 /*
   FILE *FOpen1, *FOpen2, *FOpen3;
   AnsiString resj;
   AnsiString restotal;
   AnsiString couts;
   AnsiString path1 = AnsiString(ProjectDirectory)+"\\"+ProjectName+"couts";
   AnsiString path2 = AnsiString(ProjectDirectory)+"\\"+ProjectName+"rest";
   AnsiString path3 = AnsiString(ProjectDirectory)+"\\"+ProjectName+"resj";
   string line, line2, line3;
   ifstream monFichier1;
   ifstream monFichier2;
   ifstream monFichier3;
   int i = 1; int j = 1; int k= 1;
   if(monFichier1.is_open(path1.c_str()))
   {
    while(getline(monFichier1,line))
    {
      AdvStringGrid1->Cells[14][i]=line;
      i++;
    }
    monFichier1.close(),
   }else{
             monFichier1.open(path1.c_str());
             monFichier1 <<"\n";
             monFichier1.close();
   ...
   if(monFichier2.is_open(path2.c_str()))
   {
    while(getline(monFichier2,line2))
    {
      AdvStringGrid1->Cells[23][j]=line2;
     j++;
    }
    monFichier2.close(),
   }else{
             monFichier2.open(path2.c_str(), fstream::in | fstream::trunc);
             monFichier2 <<"\n";
             monFichier2.close();
   ...
   if(monFichier3.is_open(path3.c_str()))
   {
    while(getline(monFichier3,line3))
    {
      AdvStringGrid1->Cells[24][k]=line3;
      k++;                                                  feofjze
    }
    monFichier3.close(),
   }else{
             monFichier3.open(path3.c_str(), fstream::in |fstream::trunc);
             monFichier3 <<"\n";
             monFichier3.close();
...
void __fastcall TplStandard::Button133Click(TObject *Sender)
{   for(int i= 1;i < AdvStringGrid10->RowCount;i++){
    AdvStringGrid1->Cells[14][i]=   AdvStringGrid10->Cells[14][i];
  AdvStringGrid1->Cells[17][i]=   AdvStringGrid10->Cells[17][i];
 AdvStringGrid1->Cells[18][i]=   AdvStringGrid10->Cells[18][i];
 AdvStringGrid1->Cells[19][i]=   AdvStringGrid10->Cells[19][i];
  AdvStringGrid1->Cells[20][i]=   AdvStringGrid10->Cells[20][i];
 AdvStringGrid1->Cells[21][i]=   AdvStringGrid10->Cells[21][i];

 AdvStringGrid1->Cells[22][i]=   AdvStringGrid10->Cells[22][i];
   AdvStringGrid1->Cells[23][i]=   AdvStringGrid10->Cells[23][i];
   AdvStringGrid1->Cells[24][i]=   AdvStringGrid10->Cells[24][i];
  AdvStringGrid1->Cells[26][i]=   AdvStringGrid10->Cells[14][i];
   AdvStringGrid1->Cells[27][i]=   AdvStringGrid10->Cells[23][i];
   AdvStringGrid1->Cells[28][i]=   AdvStringGrid10->Cells[24][i];
...
void __fastcall TplStandard::Timer4Timer(TObject *Sender)
{
 // Button133->Click();
...
void __fastcall TplStandard::Button122Click(TObject *Sender)
{
   P_GENRE[pc]='C';
 strcpy(P_COLONNES[pc],"");
}
...
void __fastcall TplStandard::Timer5Timer(TObject *Sender)
{
Button133->Click();
...
for(int i = 1; i < AdvStringGrid1->RowCount;i++){
          nr=StrToInt(AdvStringGrid1->Cells[1][i]);
  AdvStringGrid1->Cells[14][i]=   AdvStringGrid9->Cells[14][nr];
  AdvStringGrid1->Cells[17][i]=   AdvStringGrid9->Cells[17][nr];
 AdvStringGrid1->Cells[18][i]=   AdvStringGrid9->Cells[18][nr];
 AdvStringGrid1->Cells[19][i]=   AdvStringGrid9->Cells[19][nr];
  AdvStringGrid1->Cells[20][i]=   AdvStringGrid9->Cells[20][nr];
 AdvStringGrid1->Cells[21][i]=   AdvStringGrid9->Cells[21][nr];

 AdvStringGrid1->Cells[22][i]=   AdvStringGrid9->Cells[22][nr];
   AdvStringGrid1->Cells[23][i]=   AdvStringGrid9->Cells[23][nr];
   AdvStringGrid1->Cells[24][i]=   AdvStringGrid9->Cells[24][nr];
  AdvStringGrid1->Cells[26][i]=   AdvStringGrid9->Cells[14][nr];
   AdvStringGrid1->Cells[27][i]=   AdvStringGrid9->Cells[23][nr];
   AdvStringGrid1->Cells[28][i]=   AdvStringGrid9->Cells[24][nr];
  }
}
//---------------------------------------------------------------------------
void __fastcall TplStandard::exportcentr(bool question)
 {
 ...
 AnsiString numerota;
  ...
  for (i=1; i<=av->RowCount; i++)
        ...
        {
         numerota=       AdvStringGrid1->Cells[1][i];
         if (av->Cells[1][i] != "" &&av->Cells[1][i] == numerota)
          {
            strcpy(tmp,"");
            strcat(tmp,"\""); strcat(tmp,av->Cells[1][i].c_str()); strcat(tmp,"\",");  // N°
            strcat(tmp,"\""); strcat(tmp,av->Cells[2][i].c_str()); strcat(tmp,"\",");  // Des
...
void __fastcall TplStandard::Timer7Timer(TObject *Sender)
{

    if(boucle == true)
    {
     RemoveSuccSeul(ctache, tache);
     RemovePredSeul(tache,ctache);
     grefresh(ctache,'0'); // current_task,'1');
     boucle = false;
    }
...
void __fastcall TplStandard::Button34Click(TObject *Sender)
{

  if(AdvStringGrid1->Cells[1][3] != "" &&AdvStringGrid1->Cells[1][2] != ""){

AnsiString InputString = InputBox("Export Centralisation des taches", "Veuillez donner un nom", "Taches");
if(InputString =="")
{
 ShowMessage("Le nom de fichier est vide!");
 return;
}else{
ofstream myfile;
  myfile.open ("Liste.ecol");
  myfile << InputString.c_str();
  myfile.close();
AdvStringGrid1->SaveToFile(InputString);
}


                                     }else{ShowMessage("Pas de taches disponible"); return;}
...
void __fastcall TplStandard::Button40Click(TObject *Sender)
{

               string line;
  ifstream myfile ("Liste.ecol");
  if (myfile.is_open())
  {
    while ( getline (myfile,line) )
    {
        ListBox1->Items->Add(line.c_str());
    }
    myfile.close();
         PageControl1->ActivePageIndex =20;


  }
  else{ ShowMessage("Import pas possible, fichier corrompus ou nonexistant");
 PageControl1->ActivePageIndex =0; TabSheet20->Visible=false;}
...
void __fastcall TplStandard::Button431Click(TObject *Sender)
{
Button34->Click();
}
//---------------------------------------------------------------------------

void __fastcall TplStandard::Button43Click(TObject *Sender)
{
TShiftState Shift;
AdvStringGrid8->RowCount =2;
int co=AdvStringGrid1->RowCount-1;
for(int i=1; i<AdvStringGrid8->RowCount; i++)
{
  AdvStringGrid8->Cells[0][var1] ="";
AdvStringGrid8->Cells[1][var1] = "";
AdvStringGrid8->Cells[2][var1] = "";
AdvStringGrid8->Cells[3][var1] = "";
AdvStringGrid8->Cells[4][var1] = "";
AdvStringGrid8->Cells[5][var1] = "";
AdvStringGrid8->Cells[6][var1] = "";
}


for (int i= StrToInt(Label181->Caption);i<=co;i++){
effacer_tache(i,i);                                     }
...
{ if(i==0||i==2||i==3||i==4||i==6||i==7||i==10||i==13)
    PageControl1->Pages[i]->TabVisible = true;
 }
TabSheet15->Visible= false;
PageControl1->ActivePageIndex=0;
...
void __fastcall TplStandard::ListBox1Click(TObject *Sender)
{
int indx = ListBox1->ItemIndex;

Edit1->Text =ListBox1->Items->Strings[indx];
}
//---------------------------------------------------------------------------

void __fastcall TplStandard::Button45Click(TObject *Sender)
{
TabSheet20->Hide();
PageControl1->ActivePageIndex = 0;
//Timer8->Enabled = true;
...
void __fastcall TplStandard::Button46Click(TObject *Sender)
{
     PageControl1->ActivePageIndex =0; TabSheet20->Hide();
}
//---------------------------------------------------------------------------

void __fastcall TplStandard::Button47Click(TObject *Sender)
{
//AdvStringGrid15->LoadFromFile(Edit1->Text);

}
//---------------------------------------------------------------------------

void __fastcall TplStandard::Timer8Timer(TObject *Sender)
{
Button48->Click();
...
void __fastcall TplStandard::Button48Click(TObject *Sender)
{
/*
AdvStringGrid14->LoadFromFile(Edit1->Text);
        for(int i= 1; i<AdvStringGrid14->RowCount;i++)
        {

        AdvStringGrid1->SetFocus();
        keybd_event(VK_INSERT,0x2D, 0 , 0);
        if(i >=2){
AdvStringGrid1->Cells[2][i]=        AdvStringGrid14->Cells[2][i];
AdvStringGrid1->Cells[3][i]=        AdvStringGrid14->Cells[3][i];
AdvStringGrid1->Cells[13][i]=       AdvStringGrid14->Cells[5][i];
AdvStringGrid1->Cells[11][i]=       AdvStringGrid14->Cells[11][i];
AdvStringGrid1->Cells[18][i]=       AdvStringGrid14->Cells[18][i];
AdvStringGrid1->Cells[19][i]=       AdvStringGrid14->Cells[19][i];
AdvStringGrid1->Cells[20][i]=       AdvStringGrid14->Cells[20][i];
AdvStringGrid1->Cells[21][i]=       AdvStringGrid14->Cells[21][i];
AdvStringGrid1->Cells[22][i]=       AdvStringGrid14->Cells[22][i];
AdvStringGrid1->Cells[23][i]=       AdvStringGrid14->Cells[23][i];
AdvStringGrid1->Cells[24][i]=       AdvStringGrid14->Cells[24][i];
                 }
        }
  */
}
...
void __fastcall TplStandard::Button413Click(TObject *Sender)
{
...
void __fastcall TplStandard::TabSheet15ContextPopup(TObject *Sender,
      TPoint &MousePos, bool &Handled)
{
kj=0;
counter=0;
if(abstate==2)
TabSheet15->Caption="Taches en amont";
}
//---------------------------------------------------------------------------


void __fastcall TplStandard::Timer9Timer(TObject *Sender)
{
...
void __fastcall TplStandard::Timer10Timer(TObject *Sender)
{
...
void __fastcall TplStandard::Button51Click(TObject *Sender)
{
AnsiString ccd= ".project";
AnsiString cc= ProjectName;
AppendStr(cc,ccd);
AdvStringGrid1->LoadFromFile(cc);

}
//---------------------------------------------------------------------------

void __fastcall TplStandard::Button49Click(TObject *Sender)
{
...
for(int i=1;i <AdvStringGrid1->RowCount;i++)
{
    ...
    AdvStringGrid1->Cells[19][i]=asCrit->Cells[7][i];
    AdvStringGrid1->Cells[20][i]=asCrit->Cells[9][i];
    AdvStringGrid1->Cells[22][i]=AdvStringGrid16->Cells[22][i];
    AdvStringGrid1->Cells[23][i]=AdvStringGrid16->Cells[23][i];
    AdvStringGrid1->Cells[24][i]=AdvStringGrid16->Cells[24][i];
    AdvStringGrid1->Cells[25][i]=AdvStringGrid16->Cells[25][i];
}
...
//---------------------------------------------------------------------------
void __fastcall TplStandard::tachemereamont(int numero)
{
       int ix,ctask;
 char tache[50];
 AnsiString proj = ProjectName;
 AnsiString design;
 AnsiString tacheMA,tacheFI;
 AnsiString nomFichier;
 AnsiString datedebt;
 AnsiString datefint;
 AnsiString datedebt2;
 AnsiString datefint2;


Label180->Caption = Label15->Caption;
Label181->Caption = AdvStringGrid1->RowCount;

vectorpred.clear();
vectorsucc.clear();
if(numero==1){
des=InputBox("Tache mère","Veuillez entrer une designation pour la tache mère","ASXFD");
des2=InputBox("Tache mère","Veuillez entrer une designation pour la tache fille","ASXFD");
abstate=1;
}


for(int ij= 1;ij<AdvStringGrid2->RowCount;ij++)
{
vectorpred.push_back(StrToInt(AdvStringGrid2->Cells[7][ij]));
}


for(int ij= 1;ij<AdvStringGrid3->RowCount;ij++)
{
vectorsucc.push_back(StrToInt(AdvStringGrid3->Cells[7][ij]));
}
int minElementIndex = std::min_element(vectorpred.begin(),vectorpred.end()) - vectorpred.begin();
int minElementIndex2 = std::min_element(vectorsucc.begin(),vectorsucc.end()) - vectorsucc.begin();


Label183->Caption = minElementIndex+1;
Label184->Caption = minElementIndex2+1;



 for (ix=1;ix<=LASTTASK;ix++)
   {
   if(Label16->Caption == "1"){
     if (coche[ix]=='X')
         {
         Label185->Caption = AdvStringGrid1->Cells[1][ix];
        Label187->Caption = AdvStringGrid1->Cells[5][ix];
AdvStringGrid8->Cells[0][1] = AdvStringGrid1->Cells[2][ix];
AdvStringGrid8->Cells[1][1] = AdvStringGrid1->Cells[3][ix];
AdvStringGrid8->Cells[2][1] = AdvStringGrid3->Cells[5][1];
AdvStringGrid8->Cells[3][1] = AdvStringGrid3->Cells[6][1];
AdvStringGrid8->Cells[4][1] = AdvStringGrid1->Cells[20][1];
AdvStringGrid8->Cells[5][1] = "0";
AdvStringGrid8->Cells[6][1] = AdvStringGrid3->Cells[1][minElementIndex2+1];
AdvStringGrid8->Cells[7][1] =des;
         }                     }else{
          ShowMessage("Aucune tâche selectionnée");
          return;

         }
     }
Label188->Caption = IntToStr(AdvStringGrid3->RowCount)-1;
Label189->Caption = IntToStr(AdvStringGrid2->RowCount)-1;
vectorpred.clear();
vectorsucc.clear();
 for (int i(0); i < PageControl1->PageCount; ++i)
    PageControl1->Pages[i]->TabVisible = false;

TabSheet15->Visible= true;
PageControl1->ActivePageIndex=15;

}
void __fastcall TplStandard::Button52Click(TObject *Sender)
{
 int ctaches=StrToInt(Label185->Caption);
 int nrtt= StrToInt(Label180->Caption);
 int ress;
ress = nrtt+(AdvStringGrid8->Row-1);

InsertSuccSeul(ctaches,ress,1,StrToInt(AdvStringGrid8->Cells[3][AdvStringGrid8->Row]),false);
InsertPredSeul(ress,ctaches,1,StrToInt(AdvStringGrid8->Cells[3][AdvStringGrid8->Row]),false);
 AdvStringGrid1->Row=ctaches;


 grefresh(current_task,'0');
 AdvStringGrid1->Row=ctaches;

Clear_Diagram(Image2);
 DrawMiniGantt(ctaches,0,Image2,false);
...
void __fastcall TplStandard::AdvStringGrid8CellValidate(TObject *Sender,
      int ACol, int ARow, AnsiString &Value, bool &Valid)
{
AnsiString MemoDecal22= AdvStringGrid8->Cells[ACol][ARow];

 int ctaches=StrToInt(Label185->Caption);
 int numtc =StrToInt(Label181->Caption);
 int nrtt= StrToInt(Label180->Caption);
int ress;
numtc = numtc+((AdvStringGrid8->Row)-2);
 int idecal;
 int typl;
 int bcb;
 char ctype;
 int Val;
 Val= StrToInt(Value);
int Val1 = StrToInt(AdvStringGrid8->Cells[1][ARow]);
int Val3= StrToInt(AdvStringGrid8->Cells[3][ARow]);
int Val4=  StrToInt(AdvStringGrid8->Cells[1][1]);
int res1;

 if(Val>0 && ACol != 1)
 {
  ShowMessage("Les taches filles ne peuvent depasser la tâche mère!");
  return;
 }
...
if(ACol == 1)
{
 ...
 if(res1>Val4)
 {
   AdvStringGrid8->Cells[1][ARow]=value1;
   ShowMessage("Les taches filles ne peuvent depasser la tâche mère!");
   return;
 }
}
...
if(ACol == 3)
{
 ...
 if(res1>Val4)
 {
   AdvStringGrid8->Cells[3][ARow]=value1;
   ShowMessage("Les taches filles ne peuvent depasser la tâche mère!");
   return;
 }
}
...
int abc=AdvStringGrid1->RowCount;
if(ACol==1){
if(ARow != 1) {
ress = nrtt+(ARow-1);
/*av->Cells[2][ress]= AdvStringGrid8->Cells[0][ARow];
av->Cells[11][ress]= AdvStringGrid8->Cells[7][ARow];
av->Cells[3][ress]=Value;
AdvStringGrid1->Cells[17][ress] = "P---";
AdvStringGrid1->Cells[18][ress] = "I---";
AdvStringGrid1->Cells[19][ress] = "T---";
AdvStringGrid1->Cells[20][ress] = AdvStringGrid8->Cells[4][ARow];*/
Valid=true;
...
if(ACol==4)
{
AdvStringGrid8->Cells[4][ARow]=Value;
Valid=true;

}
int val;
int nrtt2= StrToInt(Label188->Caption);
if(ACol==3){
if(ARow != 1){
ress = nrtt+(ARow-1);
val= StrToInt(Value);
//InsertSuccSeul(ctaches,ress,1,val,false);
//InsertPredSeul(ress,ctaches,1,val,false);
/*
av->Cells[2][ress]= AdvStringGrid8->Cells[0][ARow];
av->Cells[11][ress]= AdvStringGrid8->Cells[7][ARow];
av->Cells[3][ress]=Value;
...
Button52Click(Sender);
   }
//---------------------------------------------------------------------------

void __fastcall TplStandard::Button41Click(TObject *Sender)
{
 AdvStringGrid8->RowCount =2;
for(int i=1; i<AdvStringGrid8->RowCount; i++)
{
...
void __fastcall TplStandard::Button53Click(TObject *Sender)
{
AdvStringGrid1->Cells[11][1] = "Code";
AdvStringGrid1->Cells[8][1]= "DF";
AdvStringGrid1->Cells[9][1] = "0";
AdvStringGrid1->Cells[10][1]= AdvStringGrid3->Cells[1][1];
}
//---------------------------------------------------------------------------


void __fastcall TplStandard::Button54Click(TObject *Sender)
{
TShiftState Shift;
...
int nt;
int nrtt= StrToInt(Label181->Caption);
TDate datefinf =StrToDate(Label187->Caption);
TDate tmp2;
  int decal,tl;
  char tmp[250];
  int ix; int first; int previous;
  int cnt; AnsiString XX;
  numtc =StrToInt(Label181->Caption);
   ctaches=StrToInt(Label185->Caption);
   int nru = AdvStringGrid1->RowCount;
 int compter1=StrToInt(Edit2->Text);
for(int j= 0; j< i;j++)
AdvStringGrid8KeyDown(Sender,VK_INSERT, Shift);
if(abstate==1){
for(int k=numtc; k<AdvStringGrid1->RowCount;k++)
{

InsertSuccSeul(ctaches,numtc,1,0,false);
InsertPredSeul(numtc,ctaches,1,0,false);
 numtc=numtc+1;
}
}
...
void __fastcall TplStandard::AdvStringGrid8ClickCell(TObject *Sender,
      int ARow, int ACol)
{
...
if(ACol==4)
{
 ...
 for(int j=1;j<asCrit->RowCount;j++)
 {
  asCrit->Cells[0][j]=' ';
  coch[j]=' ';
 }
  Coche_Decoche_Crit(0,ress);
        btAccCritClick(Sender);
}
...
AdvStringGrid1->Cells[20][i] =     asCrit->Cells[9][i];
  ...
  AdvStringGrid1->Cells[22][i] =   av->Cells[82][i];
  AdvStringGrid1->Cells[23][i] =   av->Cells[85][i];
AdvStringGrid1->Cells[24][i] =     av->Cells[86][i];

}


Button55Click(Sender);*/
}
//---------------------------------------------------------------------------
...
void __fastcall TplStandard::Button55Click(TObject *Sender)
{
 ...
 if (fp)
  {
    ...
    {if (strlen(buff)>5)
      {
      Ghost->ExtractValue(c1,buff,"c1",0);
      Ghost->ExtractValue(c2,buff,"c2",0);
      Ghost->ExtractValue(c3,buff,"c3",0);
      Ghost->ExtractValue(c4,buff,"c4",0);
      Ghost->ExtractValue(des,buff,"d",0);
...
void __fastcall TplStandard::AdvStringGrid8CanEditCell(TObject *Sender,
      int ARow, int ACol, bool &CanEdit)
{
if(ARow == 1)
return;        
...
void __fastcall TplStandard::ListBox2Click(TObject *Sender)
{
int indx;
int colAdv;
AnsiString dd;
...
colAdv=AdvStringGrid8->Row;
dd= ListBox2->Items->Strings[indx];
if(colAdv==1)
return;
AdvStringGrid8->Cells[0][colAdv]=dd22;
int strlength=dd.Length();
int spacepl=dd.Pos(" ");
str22=dd.SubString(1,spacepl-1);

AdvStringGrid8->Cells[4][colAdv]=str22;
AnsiString dd222=AdvStringGrid8->Cells[0][colAdv];
str22tmp=AdvStringGrid8->Cells[7][colAdv]+str22;
AdvStringGrid8->Cells[0][colAdv]=str22tmp;
ress = nrtt+(colAdv-1);

AdvStringGrid1->Cells[2][ress]= AdvStringGrid8->Cells[0][colAdv];
AdvStringGrid1->Cells[11][ress]= AdvStringGrid8->Cells[7][colAdv];
AdvStringGrid1->Cells[3][ress]=AdvStringGrid8->Cells[1][colAdv];
AdvStringGrid1->Cells[17][ress] = "P---";
AdvStringGrid1->Cells[18][ress] = "I---";
AdvStringGrid1->Cells[19][ress] = "T---";
...
AdvStringGrid1CellValidate(Sender,2, ress,  AdvStringGrid8->Cells[0][colAdv], true);
AdvStringGrid1CellValidate(Sender,11, ress,  AdvStringGrid8->Cells[7][colAdv], true);
AdvStringGrid1CellValidate(Sender,3, ress,  AdvStringGrid8->Cells[1][colAdv], true);
AdvStringGrid1CellValidate(Sender,17, ress,  "P---", true);
AdvStringGrid1CellValidate(Sender,18, ress,  "I---", true);
...
void __fastcall TplStandard::Button56Click(TObject *Sender)
{
double x;
AnsiString str22;
AnsiString tmpt;
...
Series1->Clear();
Series2->Clear();
for(int i=1;i<ave->RowCount;i++)
Series1->AddBar(StrToFloat(ave->Cells[4][i]),ave->Cells[1][i],clRed);


for(int j=1;j<ave->RowCount;j++){
str22=ave->Cells[4][j];
if(j+1<ave->RowCount)
str222=ave->Cells[4][j+1];
x= StrToFloat(str222)+StrToFloat(str22);
Series2->XValues->Order=loNone;
Series2->HasZValues=true;
Series2->Add(x,ave->Cells[1][j],clBlue);

}
TabSheet22->Visible= true;
PageControl1->ActivePageIndex=22;
}
//---------------------------------------------------------------------------


void __fastcall TplStandard::Button57Click(TObject *Sender)
{
int ix;
 ...
 for (ix=1;ix<=LASTTASK;ix++)
   {
      if (coche[ix]=='X')
         {
         	 for(int j=1;j<AdvStringGrid15->RowCount;j++){
	AdvStringGrid15->Cells[1][j]=AdvStringGrid1->Cells[1][ix];
	AdvStringGrid15->Cells[2][j]=AdvStringGrid1->Cells[2][ix];
	AdvStringGrid15->Cells[3][j]=AdvStringGrid1->Cells[3][ix];
	AdvStringGrid15->Cells[4][j]=AdvStringGrid1->Cells[4][ix];
	AdvStringGrid15->Cells[5][j]=AdvStringGrid1->Cells[5][ix];
	AdvStringGrid15->Cells[6][j]=AdvStringGrid1->Cells[6][ix];
	AdvStringGrid15->Cells[7][j]=AdvStringGrid1->Cells[7][ix];
    AdvStringGrid15->Cells[8][j]=AdvStringGrid1->Cells[9][ix];
	AdvStringGrid15->Cells[9][j]=AdvStringGrid1->Cells[10][ix];
	AdvStringGrid15->Cells[10][j]=AdvStringGrid1->Cells[11][ix];
	AdvStringGrid15->Cells[11][j]=AdvStringGrid1->Cells[12][ix];
	AdvStringGrid15->Cells[12][j]=AdvStringGrid1->Cells[13][ix];
	AdvStringGrid15->Cells[13][j]=AdvStringGrid1->Cells[17][ix];
	AdvStringGrid15->Cells[14][j]=AdvStringGrid1->Cells[18][ix];
	AdvStringGrid15->Cells[15][j]=AdvStringGrid1->Cells[19][ix];
	AdvStringGrid15->Cells[16][j]=AdvStringGrid1->Cells[20][ix];
	AdvStringGrid15->Cells[17][j]=AdvStringGrid1->Cells[22][ix];
	AdvStringGrid15->Cells[18][j]=AdvStringGrid1->Cells[23][ix];
	AdvStringGrid15->Cells[19][j]=AdvStringGrid1->Cells[24][ix];
	}
                              }else{
          ShowMessage("Aucune tâche selectionnée");
          return;
